...
- 🎓 **Formação**: Tecnologia em analise e desenvolvimento de sistemas - Newton Paiva.
      E estou cursando a Pós-Graduação em desenvovledor Full Stack pela Puc Minas
- 💻 **Habilidades**: Java, JavaScript, HTML5/CSS3, Flutter,Php .<br>
[![](https://skillicons.dev/icons?i=java,javascript,php,flutter)](https://skillicons.dev)
...
<br>
- **Biblioteca de HYPERCARROS** Um site padrão com um belo layout que você pode cadastrar,editar e excluir marcas e modelos de hypercarros<br>
Link: https://github.com/joaopedro0013/HyperCar_Biblioteca
---
